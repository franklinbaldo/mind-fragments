...
title: Adding new posts in Mind Fragments theme
...
tags:
  - docs
description:
  Some rules & recommendations for creating or adding new posts using Mind Fragments
  theme.
---

Here are some rules/recommendations, tips & ticks for creating new posts in Mind Fragments blog theme.
...
Title and description (excerpt) are important for search engine optimization (SEO) and thus Mind Fragments encourages to include these in blog posts.
...
Here are some recommendations, tips & ticks for creating new posts in Mind Fragments blog theme.
...
There's one thing to note about headings. The Mind Fragments blog posts use title (title in the frontmatter) as the main heading of the post. Therefore, the rest of the heading in the post should be using h2 \~ h6.
...
> In Mind Fragments, OG images will be generated automatically if not specified. Check out [the announcement](https://astro-paper.pages.dev/posts/dynamic-og-image-generation-in-astropaper-blog-posts/) for details on the original feature.
